...
const compileTypeScriptIfRequired = require('puppeteer-core/typescript-if-required');
...
async function download(options) {
  ...
  const browserFetcher = puppeteer.createBrowserFetcher({product, host: downloadHost,path:options.executablePath});
  ...
  function getRevision() {
    if (product === 'chrome') {
      ...
      puppeteer._preferredRevision = require('puppeteer-core/package.json').puppeteer.firefox_revision;
